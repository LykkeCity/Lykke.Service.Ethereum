...
{
    [UsedImplicitly]
    public sealed class BalanceObservationQueueConsumerBase : QueueConsumerBase<(BalanceObservationTask Task, string CompletionToken)>
    {
        private readonly IBalanceObservationService _balanceObservationService;
        private readonly ILog _log;
        
        
        public BalanceObservationQueueConsumerBase(
